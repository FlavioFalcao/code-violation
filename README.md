...
* Review existing code violations
* Create new code violations
* Add related inspection information

## Instructions

### Your Services

[Detailed help](http://links.esri.com/localgovernment/help/10.2/CodeViolationforiOS)
...
* Apple iOS SDK 6.0 or higher
* Xcode 4.0 or higher
* ArcGIS API for iOS 10.1.1 - [About](https://developers.arcgis.com/en/ios/)

### Your Services

* ArcGIS for Desktop 10.2 - Standard or Advanced - [About](http://www.esri.com/software/arcgis/arcgis-for-desktop)
* ArcGIS for Server 10.2 - Standard or Advanced, or an ArcGIS Online organizational account - [About](http://www.esri.com/software/arcgis/arcgisserver)
